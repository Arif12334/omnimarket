...
export const SAMPLE_MARKETS: Market[] = [
  {
    id: 'market-1',
    name: 'NovaTech Flagship Superstore',
    slug: 'novatech-flagship',
    category: 'phones',
    categoryName: 'Phones & Tablets',
    description: 'Direct manufacturer outlet for flagship 5G phones, tablets, and next-gen smart mobile accessories with official 2-year warranty.',
    location: 'Silicon Valley, California',
    address: '450 Innovation Way, Suite 100',
    city: 'San Jose',
    country: 'United States',
    ...
    ownerEmail: 'elena@novatech-store.com',
    establishedYear: 2021,
    openingHours: '8:00 AM - 10:00 PM (Mon-Sun)',
    isOpen: true,
    isAmazonFulfilled: true,
    tags: ['Official Brand', 'Fast 1-Day Ship', 'Verified Merchant', 'Electronics'],
    createdAt: '2023-01-15T08:00:00.000Z'
  },
  {
    id: 'market-2',
    name: 'Aura Studio & Luxe Fashion',
    slug: 'aura-studio-luxe',
    category: 'fashion',
    categoryName: 'Fashion & Apparel',
    description: 'Curated premium minimalist apparel, sustainable Italian leather wear, and contemporary seasonal collections.',
    location: 'SoHo, New York',
    address: '128 Mercer Street',
    city: 'New York',
    country: 'United States',
    phone: '+1 (212) 555-4821',
    email: 'concierge@aurastudio.com',
    bannerImage: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1200&auto=format&fit=crop&q=80',
    logoImage: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=400&auto=format&fit=crop&q=80',
    rating: 4.8,
    reviewCount: 950,
    ...
    ownerEmail: 'julian@aurastudio.com',
    establishedYear: 2022,
    openingHours: '10:00 AM - 9:00 PM (Daily)',
    isOpen: true,
    isAmazonFulfilled: true,
    tags: ['Luxury Wear', 'Eco-Friendly', 'Verified Merchant'],
    createdAt: '2023-04-20T10:00:00.000Z'
  },
  {
    id: 'market-3',
    name: 'GreenBounty Organic Farm Market',
    slug: 'greenbounty-organics',
    category: 'groceries',
    categoryName: 'Groceries & Fresh',
    description: 'Farm-to-table organic produce, cold-pressed oils, artisan pantry staples, and fair-trade international delicacies.',
    location: 'Portland, Oregon',
    address: '820 Green Valley Blvd',
    city: 'Portland',
    country: 'United States',
    phone: '+1 (503) 555-7390',
    email: 'orders@greenbounty.org',
    bannerImage: 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=1200&auto=format&fit=crop&q=80',
    logoImage: 'https://images.unsplash.com/photo-1610832958506-aa56368176cf?w=400&auto=format&fit=crop&q=80',
    rating: 4.95,
    reviewCount: 3120,
    ...
    ownerEmail: 'sarah@greenbounty.org',
    establishedYear: 2019,
    openingHours: '6:30 AM - 8:30 PM (Daily)',
    isOpen: true,
    isAmazonFulfilled: true,
    tags: ['100% Organic', 'Local Harvest', 'Prime 2hr Fresh'],
    createdAt: '2022-11-10T14:30:00.000Z'
  }
];
